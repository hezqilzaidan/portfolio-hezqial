    ...
    return {
      ...
      tech: [
        ...
        },
        {
          id: 6,
          name: 'C#',
          imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d2/C_Sharp_Logo_2023.svg/192px-C_Sharp_Logo_2023.svg.png',
          status: 'Beginner'
        },
        {
          id: 7,
      ...
      tools: [
        ...
        },
        {
          id: 5,
          name: 'Elementor',
          imageUrl: 'https://cdn.wpml.org/wp-content/uploads/2017/09/Elementor-Logo-Symbol-Red.png',
          status: 'Wordpress'
        },
        {
          id: 6,
          name: 'Frammer',
          imageUrl: 'https://static-00.iconduck.com/assets.00/framer-icon-2048x2048-msauaaio.png',
          status: 'App Design'
        },
        {
          id: 7,
        ...
        },
        {
          id: 8,
          name: 'Visual Studio',
          imageUrl: 'https://chris-ayers.com/assets/images/vscode-logo.png',
          status: 'Code Editor'
        },
        {
          id: 10,
          name: 'Adobe Illustrator',
          imageUrl: 'https://seeklogo.com/images/A/adobe-illustrator-logo-775FAF240B-seeklogo.com.png',
        ...
        },
        {
          id: 12,
          name: 'Canva',
          imageUrl: 'https://freepnglogo.com/images/all_img/1691829400logo-canva-png.png',
          status: 'Graphic Design'
        },
        {
          id: 13,
          name: 'VN',
          imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTRzbfUtqtOFGdiPKsPX1dzB7uBk2Py4WlYyw&s',
          status: 'Video Editor'
        },
      ]
    };
      ...
      <section
        ...
        <div class="flex justify-center">
          <img class="w-9/12 rounded-full mb-3 fadein-up"
            src="https://cdn3d.iconscout.com/3d/premium/thumb/employee-avatar-10232456-8264146.png" alt="Foto">
        </div>
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi everyone! My name is Ahmed Hezqial Zaidan. I'm a web developer from Bekasi, West Java. I
