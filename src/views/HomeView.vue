<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      ...
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">Ahmed Hezqial Zaidan</h1>
      <div class="py-2">
        <h1
      ...
      <p class="text-white pr-4 fade-in-from-left">Welcome to My Portofolio Website. <span class="wave">👋🏼</span></p>
      <br>
      <a href="/https://www.linkedin.com/in/ahmedhezqialzaidan/">  <button
    ...
    <div class="flex justify-center md:justify-start fadein-right"><img alt="avatar" fetchpriority="high" width="10" height="10" decoding="async" data-nimg="1"
        class="w-10/12 md:h-auto rounded-full border-4 border-amber-200 pict" src="https://cdn3d.iconscout.com/3d/premium/thumb/man-avatar-10253459-8330274.png">
    </div>
  </main>
</template>
